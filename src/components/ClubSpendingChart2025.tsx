    ...
    <Card className="border-gray-200/50 shadow-lg mb-6" style={{ backgroundColor: '#2F517A' }}>
      <div className="p-3 sm:p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-xl font-bold text-blue-400">Club Spending 2025 Summer Window</h3>
        </div>
        
        <div className="h-96">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={clubSpendingData} margin={{ top: 20, right: 30, left: 20, bottom: 60 }}>
