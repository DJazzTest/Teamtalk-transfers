...
export interface Player {
  ...
  shirtNumber?: number;
  /**
   * Squad/ownership status, used to distinguish active players from loans and transfers.
   * - active: in this club's current squad
   * - loan_out: owned by this club but currently playing elsewhere
   * - loan_in: temporarily at this club but owned by another
   * - sold: permanently transferred away
   * - released: contract terminated / free agent
   */
  status?: 'active' | 'loan_out' | 'loan_in' | 'sold' | 'released';
  /** Club the player currently plays matches for (can differ from the parent club when on loan). */
  currentClub?: string;
  /** Owning/parent club for loaned players. */
  parentClub?: string;
  /** Convenience alias for the loan destination when status === 'loan_out'. */
  loanClub?: string;
...
const createImageOnlySquad = (
  teamSlug: string,
  names: string[],
  overrides?: Partial<Record<string, Pick<Player, 'status' | 'currentClub' | 'parentClub' | 'loanClub'>>,
): Player[] => {
...
export const clubSquads: Record<string, Player[]> = {
  ...
  'Aston Villa': [
    // Default assumption: if not marked otherwise, players are active in Aston Villa's squad
    { name: 'Boubacar Kamara', position: 'Midfielder', weeklyWage: 150000, yearlyWage: 7.8, status: 'active', currentClub: 'Aston Villa' },
    { name: 'Youri Tielemans', position: 'Midfielder', weeklyWage: 150000, yearlyWage: 7.8, status: 'active', currentClub: 'Aston Villa' },
    { name: 'Emiliano Martínez', position: 'Goalkeeper', weeklyWage: 150000, yearlyWage: 7.8, status: 'active', currentClub: 'Aston Villa' },
    // Donyell Malen – Transfer Out - Roma
    { name: 'Donyell Malen', position: 'Forward', weeklyWage: 140000, yearlyWage: 7.28, status: 'sold', parentClub: 'Aston Villa', currentClub: 'Roma' },
    { name: 'Amadou Onana', position: 'Midfielder', weeklyWage: 140000, yearlyWage: 7.28, status: 'active', currentClub: 'Aston Villa' },
    { name: 'Ollie Watkins', position: 'Forward', weeklyWage: 130000, yearlyWage: 6.76, status: 'active', currentClub: 'Aston Villa' },
    { name: 'Philippe Coutinho', position: 'Midfielder', weeklyWage: 125000, yearlyWage: 6.5, status: 'sold', parentClub: 'Aston Villa', currentClub: 'Vasco da Gama' },
    { name: 'Lucas Digne', position: 'Defender', weeklyWage: 120000, yearlyWage: 6.24, status: 'active', currentClub: 'Aston Villa' },
    { name: 'John McGinn', position: 'Midfielder', weeklyWage: 120000, yearlyWage: 6.24, status: 'active', currentClub: 'Aston Villa' },
    { name: 'Tyrone Mings', position: 'Defender', weeklyWage: 100000, yearlyWage: 5.2, status: 'active', currentClub: 'Aston Villa' },
    { name: 'Ian Maatsen', position: 'Defender', weeklyWage: 100000, yearlyWage: 5.2, status: 'active', currentClub: 'Aston Villa' },
    { name: 'Pau Torres', position: 'Defender', weeklyWage: 95000, yearlyWage: 4.94, status: 'active', currentClub: 'Aston Villa' },
    { name: 'Ezri Konsa', position: 'Defender', weeklyWage: 90000, yearlyWage: 4.68, status: 'active', currentClub: 'Aston Villa' },
    { name: 'Matty Cash', position: 'Defender', weeklyWage: 85000, yearlyWage: 4.42, status: 'active', currentClub: 'Aston Villa' },
    // Samuel Iling-Junior – Loan Out - West Brom
    { name: 'Samuel Iling-Junior', position: 'Midfielder', weeklyWage: 80000, yearlyWage: 4.16, status: 'loan_out', parentClub: 'Aston Villa', currentClub: 'West Brom', loanClub: 'West Brom' },
    { name: 'Morgan Rogers', position: 'Forward', weeklyWage: 75000, yearlyWage: 3.9, status: 'active', currentClub: 'Aston Villa' },
    // Evann Guessand – Loan Out - Crystal Palace
    { name: 'Evann Guessand', position: 'Forward', weeklyWage: 70000, yearlyWage: 3.64, status: 'loan_out', parentClub: 'Aston Villa', currentClub: 'Crystal Palace', loanClub: 'Crystal Palace' },
    { name: 'Ross Barkley', position: 'Midfielder', weeklyWage: 65000, yearlyWage: 3.38, status: 'active', currentClub: 'Aston Villa' },
    { name: 'Marco Bizot', position: 'Goalkeeper', weeklyWage: 60000, yearlyWage: 3.12, status: 'active', currentClub: 'Aston Villa' },
    { name: 'Andres Garcia', position: 'Defender', weeklyWage: 55000, yearlyWage: 2.86, status: 'active', currentClub: 'Aston Villa' },
    // Lino Sousa – Loan Out - Rotherham
    { name: 'Lino Sousa', position: 'Defender', weeklyWage: 50000, yearlyWage: 2.6, status: 'loan_out', parentClub: 'Aston Villa', currentClub: 'Rotherham', loanClub: 'Rotherham' },
    { name: 'Lamare Bogarde', position: 'Midfielder', weeklyWage: 45000, yearlyWage: 2.34, status: 'active', currentClub: 'Aston Villa' },
    // Youth / U21 players – updated with latest moves where known
    { name: 'Travis Patterson', position: 'Midfielder', weeklyWage: 40000, yearlyWage: 2.08, status: 'loan_out', parentClub: 'Aston Villa', currentClub: 'Annecy', loanClub: 'Annecy' },
    { name: 'James Wright', position: 'Midfielder', weeklyWage: 35000, yearlyWage: 1.82, status: 'active', currentClub: 'Aston Villa' },
    { name: 'Jamaldeen Jimoh', position: 'Midfielder', weeklyWage: 30000, yearlyWage: 1.56, status: 'loan_out', parentClub: 'Aston Villa', currentClub: 'West Brom', loanClub: 'West Brom' },
    { name: 'Bradley Burrowes', position: 'Midfielder', weeklyWage: 25000, yearlyWage: 1.3, status: 'active', currentClub: 'Aston Villa' },
    { name: 'George Hemmings', position: 'Forward', weeklyWage: 20000, yearlyWage: 1.04, status: 'active', currentClub: 'Aston Villa' },
    { name: 'Sam Proctor', position: 'Midfielder', weeklyWage: 15000, yearlyWage: 0.78, status: 'active', currentClub: 'Aston Villa' },
    { name: 'Triston Rowe', position: 'Midfielder', weeklyWage: 10000, yearlyWage: 0.52, status: 'loan_out', parentClub: 'Aston Villa', currentClub: 'Annecy', loanClub: 'Annecy' }
  ].map(player => ({
    ...player,
  ...
  'Tottenham Hotspur': createImageOnlySquad(
    'tottenham',
    [
      'Antonín Kinský',
      'Brandon Austin',
    ...
    {
      'Kota Takai': { status: 'loan_out', loanClub: "Borussia Mönchengladbach", currentClub: "Borussia Mönchengladbach" },
      'Dane Scarlett': { status: 'loan_out', loanClub: 'Hibernian', currentClub: 'Hibernian' },
      'Brennan Johnson': { status: 'sold', currentClub: 'Crystal Palace' },
    },
  ),
  
  // European Competition Teams
  'Newcastle United': createImageOnlySquad(
    'newcastle-utd',
    [
      'Nick Pope',
      'Aaron Ramsdale',
    ...
    {
      'Jamaal Lascelles': { status: 'sold', currentClub: 'Leicester City' },
      'Harrison Ashby': { status: 'loan_out', loanClub: 'Bradford City', currentClub: 'Bradford City' },
    },
  ),
  'West Ham United': createImageOnlySquad(
    'west-ham',
    [
      'Alphonse Areola',
      'Łukasz Fabiański',
    ...
    {
      'Igor Julio': { status: 'sold', currentClub: 'Brighton & Hove Albion' },
      'Guido Rodríguez': { status: 'sold', currentClub: 'Valencia' },
      'Lucas Paquetá': { status: 'sold', currentClub: 'Flamengo' },
      'George Earthy': { status: 'loan_out', loanClub: 'Bristol City', currentClub: 'Bristol City' },
      'Andrew Irving': { status: 'released' },
      'James Ward-Prowse': { status: 'loan_out', loanClub: 'Burnley', currentClub: 'Burnley' },
      'Callum Marshall': { status: 'loan_out', loanClub: 'VfL Bochum', currentClub: 'VfL Bochum' },
      'Luis Guilherme': { status: 'sold', currentClub: 'Sporting' },
      'Niclas Füllkrug': { status: 'sold', currentClub: 'AC Milan' },
    },
  ),
  ...
  'Wolverhampton Wanderers': createImageOnlySquad(
    'wolverhampton',
    [
      'Daniel Bentley',
      'José Sá',
    ...
    {
      'Emmanuel Agbadou': { status: 'sold', currentClub: 'Beşiktaş' },
      'Craig Dawson': { status: 'released' },
      'Ki-Jana Hoever': { status: 'loan_out', loanClub: 'Sheffield United', currentClub: 'Sheffield United' },
      'Fer López': { status: 'sold', currentClub: 'Barcelona' },
      'Tawanda Chirewa': { status: 'loan_out', loanClub: 'Barnsley', currentClub: 'Barnsley' },
      'Marshall Munetsi': { status: 'loan_out', loanClub: 'Paris FC', currentClub: 'Paris FC' },
      'Jörgen Strand Larsen': { status: 'sold', currentClub: 'Crystal Palace' },
      'Jhon Arias': { status: 'sold', currentClub: 'Palmeiras' },
    },
  ),
  ...
  'Sunderland': createImageOnlySquad(
    'sunderland',
    [
      'Robin Roefs',
      'Simon Moore',
    ...
    {
      'Anthony Patterson': { status: 'loan_out', loanClub: 'Millwall', currentClub: 'Millwall' },
      'Blondy Nna Noukeu': { status: 'sold', currentClub: 'Union Saint-Gilloise' },
      'Arthur Masuaku': { status: 'sold', currentClub: 'RC Lens' },
      'Timothée Pembélé': { status: 'loan_out', loanClub: 'Le Havre', currentClub: 'Le Havre' },
      'Aji Alese': { status: 'loan_out', loanClub: 'Portsmouth', currentClub: 'Portsmouth' },
      'Leo Fuhr Hjelde': { status: 'loan_out', loanClub: 'Sheffield United', currentClub: 'Sheffield United' },
      'Dan Neil': { status: 'loan_out', loanClub: 'Ipswich Town', currentClub: 'Ipswich Town' },
      'Jay Matete': { status: 'loan_out', loanClub: 'Milton Keynes Dons', currentClub: 'Milton Keynes Dons' },
      'Simon Adingra': { status: 'sold', currentClub: 'AS Monaco' },
    },
  ),
